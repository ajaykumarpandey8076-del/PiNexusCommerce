// ==========================================
// PiNexusCommerce - Final Restoration & Integration Fix
// ==========================================
...
// --- Render Product Cards (Without exposing confidential details) ---
function loadOpportunities(productsToDisplay = sampleProducts) {
  ...
  if (!container) {
    ...
    container.className = 'space-y-4 mb-20';
...
function renderCommerceAssistant() {
  ...
  if (!assistantContainer) {
    ...
    // Place cleanly between Global Commerce Opportunities and Search
  ...
  assistantContainer.innerHTML = `
    ...
    <!-- Listening state hidden by default -->
